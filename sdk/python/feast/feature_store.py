...
class FeatureStore:
    ...
    def get_historical_features(
        ...
        Args:
            ...
            save_as: An optional configuration that enables persisting retrieved dataset in offline store.
                All features and keys from entity_df as well as entity timestamps will be stored as a saved dataset
                and could be retrieved later.
